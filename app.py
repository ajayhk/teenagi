...
from memgpt.persistence_manager import InMemoryStateManagerWithEmbeddings, InMemoryStateManagerWithFaiss
import openai

config_list = [
    {
        "api_type": "open_ai",
        "api_base": "http://192.168.1.47:7860/v1",
        "api_key": "NULL",
    },
]
...
openai.api_base = "http://192.168.1.47:7860/v1"
openai.api_key = "NULL"
...
persona = "I am a 10x engineer, and an expert at Python."
human = "I am a team manager at this company"
memgpt_agent = presets.use_preset(presets.DEFAULT_PRESET, model='gpt-4',
                                  persona=persona, human=human, interface=interface, persistence_manager=persistence_manager,
...
if not USE_MEMGPT:
    ...
    coder = autogen.AssistantAgent(
        ...
        system_message=f"I am a 10x engineer, and an expert at Python.",
